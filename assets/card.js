...
function toggleAdditionalData(arrow) {
  const additionalHolder = document.getElementById("additionalData");
  if (additionalHolder.classList.contains("expanded")) {
    additionalHolder.classList.remove("expanded");
    arrow.style.transform = "rotate(0deg)";
  } else {
    additionalHolder.classList.add("expanded");
